                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                          ...
                          <tr>
                            ...
                            <td align="center" WIDTH="50">
                              <p>
                                ...
                                <font style="font-weight:bold;font-size:75%;color: #B89285"> Economica </font>-
                              </p>
                            </td> 
                            <td align="center" WIDTH="50">
                      ...
                      <div class="modal-footer">
                        ...
                        <a href="/carrito/agregar/vuelo/{{$vuelosi->nro_vuelo}}/{{$claseVuelo}}/{{$cantidad_viajeros}}/{{$tipoVuelo}}" class="btn btn-primary">Añadir al carrito</a>
                      </div>
                    </div>
                  </div>
                </div> 
                ...
                <div class="modal fade" id="{{ $vuelosr->nro_vuelo }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                         <a href="/carrito/agregar/vuelo/{{$vuelosr->nro_vuelo}}/{{$claseVuelo}}/{{$cantidad_viajeros}}/{{$tipoVuelo}}" class="btn btn-primary">Añadir al carrito</a>
                      </div>
                    </div>
                  </div>
                </div>
                <a href="/carrito/agregar/vuelo/{{$vuelosi->nro_vuelo}}/{{$claseVuelo}}/{{$cantidad_viajeros}}/{{$tipoVuelo}}" class="btn btn-primary">Ver Hoteles</a>
              </td>
            </tr>
      @endforeach
      </tbody>
